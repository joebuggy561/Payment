...
def AmountRequestProcess(request, account_number):
    ...
    if request.method == "POST":
        ...
        return redirect("account:dashoard")
...
def AmountRequestFinalProcess(request, account_number, transaction_id):
    ...
    if request.method == 'POST':
        ...
        if pin_number == request.user.account.pin_number:
            ...
            messages.success(request, "Your payment request has been sent sucessfully!")
...
def deletepaymentrequest(request, account_number ,transaction_id):
    ...
    if request.user == transaction.user: #make sure the person deleting the transaction is the person who is deleting it
        transaction.delete()
